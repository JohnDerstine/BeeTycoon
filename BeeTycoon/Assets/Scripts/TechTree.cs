...
public class TechTree : MonoBehaviour
{
    ...
    Dictionary<string, string> nodeDescs = new Dictionary<string, string>() {
        ...
        {"ToolSelect", "Adds chance for plot size increase to appear as an option in choice selection screens. Plots can only be expanded 3 times, once in each direction"},
